...
def telegram_success(context):
    ...
    message = (
        f"✅ <b>Пайплайн по Верный успешно завершился</b>\n"
...
@dag(
    ...
    schedule="@daily",
    catchup=False,
    description="Автоматизация обработки данных для Верный",
    tags=["Spark", "S3", "vernyi"],
...
def pipeline():
    ...
    wait_for_files = FileSensor(
        ...
        filepath="/opt/airflow/data/vernyi*",
        mode="reschedule",
        poke_interval=30,
        timeout=60,
        soft_fail=True,
    ...
    spark_processing = SparkSubmitOperator(
        ...
        application="jobs/vernyi_spark_processing.py",
        on_failure_callback=telegram_alert,
        retries=1,
