...
def telegram_success():
    message = 'Паплайн по Магнит успешно завершился'
...
@dag(
    ...
    schedule='@daily',
    catchup=False,
    description='Автоматизация обработки данных для Магнит',
    tags=['Spark', 'S3', 'magnit'],
...
def pipeline():
    ...
    spark_processing = SparkSubmitOperator(
        ...
        application='jobs/magnit_spark_processing.py',
        on_failure_callback=telegram_alert,
